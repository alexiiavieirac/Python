...
# Digamos que construa um programa para identificar níveis de CO₂ (gás carbônico) em determinados locais para evitar potenciais acidentes.

# Em cada um desses locais a sua empresa tem 5 sensores que captam o nível de CO₂ do local.
# Os níveis normais de CO₂ são em média 350. O nível de CO₂ de um local é dado pela média captada pelos 5 sensores.

# Isso significa que se tivermos os 5 sensores do Rio de Janeiro marcando: 350, 400, 450, 350, 300, o nível de CO₂
# do Rio de Janeiro será dado por: (350 + 400 + 450 + 350 + 300) / 5 = 370.

# Caso o nível seja maior que 450, um aviso deve ser exibido pelo seu programa dizendo, por exemplo: Rio de Janeiro
# está com níveis altíssimos de CO₂ (490), chamar equipe especializada para verificar a região.

# Os resultados dos sensores são monitorados a ser frequentemente dados para o sistema em forma de dicionário:
...
# Recentemente tivemos que fazer ‘backup’ dos vídeos que temos hospedados no Vimeo. Acontece que não existe um botão de Download
# de todos os vídeos em simultâneo, precisamos entrar em 1 por 1 e fazer o download manualmente.

# A alternativa é gerar um código em Python que converse com a API do Vimeo (API é uma integração que as ferramentas abrem para
# programadores poderem fazer integrações dos seus próprios programas/scripts com a ferramenta).

# Para resolver isso, nós fizemos a integração e fizemos uma \"requisição\" de todos os vídeos para a Vimeo. Essa requisição dá como resposta para o nosso código isso:
