...
1. Filtrar lista de clientes inadimplentes
    ...
    poder fazer a cobrança dos clientes.
...
lista_devedores = [(cpf, valor_devido) for cpf, valor_devido, dias in clientes_devedores if dias > 20]
print(lista_devedores)

"""
lista = []

for cpf, valor_devido, qtde_dias in clientes_devedores:
    if qtde_dias > 20:
        lista.append(cpf)
