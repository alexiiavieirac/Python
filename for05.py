...
"""
for item in lista:
    código aqui (só será executado no primeiro FOR)
    for iten2 in lista 2:
        código aqui (tanto aqui, quanto no outro)
"""
    ...
    for qtde in lista:
        if qtde < nivel_minimo:
            if fabricas[i] in fabricas_abaixo_nivel:
                pass # Isso aqui serve para não fazer nada, apenas passar para a próxima informação.
            else:
